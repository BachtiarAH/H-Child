 ...
 * @author bacht
 */
public class gizi1224 extends javax.swing.JFrame {

    /**
     * Creates new form gizi1224
     */
    public gizi1224() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Sekitar usia 1 tahun, anak biasanya sudah cukup beradaptasi", "dengan tekstur makanan pendamping yang diberikan, Sehingga", "sudah mulai diperkenalkan dengan makanan padat yang biasa ", "dimakan anggota keluarga lainya. Kebutuhan gizi anak di usia ini", "cenderung meningkat karena sedang berada di masa pertumbuhan,", "disertai dengan padatnya aktivitas harian." };
        ...
        jLabel4.setText("Kebutuhan Gizi Anak 12 - 24 Bulan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gizi1224.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
